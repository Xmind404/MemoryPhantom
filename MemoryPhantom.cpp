...
std::optional<MemoryPhantom::Vec3> MemoryPhantom::ReadVec3(const std::optional<uintptr_t>& addr) const {
    return addr ? ReadVec3(*addr) : std::nullopt;
}

std::optional<MemoryPhantom::Vec3> MemoryPhantom::ReadVec3(const std::optional<uintptr_t>& addr, int offset) const {
    return addr ? ReadVec3(*addr + offset) : std::nullopt;
}
...
bool MemoryPhantom::WriteVec3(const std::optional<uintptr_t>& addr, const Vec3& vec) const {
    return addr ? WriteVec3(*addr, vec) : false;
}

bool MemoryPhantom::WriteVec3(const std::optional<uintptr_t>& addr, int offset, const Vec3& vec) const {
