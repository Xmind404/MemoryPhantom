...
public:
    ...
    std::optional<Vec3> ReadVec3(const std::optional<uintptr_t>& addr) const;
    std::optional<Vec3> ReadVec3(const std::optional<uintptr_t>& addr, int offset) const;
    ...
    bool WriteVec3(const std::optional<uintptr_t>& addr, const Vec3& vec) const;
    bool WriteVec3(const std::optional<uintptr_t>& addr, int offset, const Vec3& vec) const;
